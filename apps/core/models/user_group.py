...
"""
create Usergroup table with fields as below:
Usergroup_members charfield
Usergroup foreignkey to group table

"""
class UserGroup(models.Model):
    Usergroup_members = models.CharField(max_length=100)
    # Usergroup = models.ForeignKey(to='Group',on_delete=CASCADE)
    def __str__(self):
        return self.Usergroup_members

# groups-fk to Usergroup