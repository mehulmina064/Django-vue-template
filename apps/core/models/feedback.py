...
"""
create feedback table with fields as below:
reference_doctype charfielld choices="Blog Post"
reference_name charfielld
ip_address charfielld
like boolean type


"""
class Feedback(models.Model):
    reference_doctype = models.CharField(max_length=100,choices=document_types)
