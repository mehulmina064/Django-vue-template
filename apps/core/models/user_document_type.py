...
"""
create Userdocument_type table with fields as below:
document_type foreign key to doctype
read booleantype degfault true
write booleantype
create booleantype
is_custom booleantype
submit booleantype
cancel booleantype
amend booleantype
delete booleantype  
...
"""
class UserDocument_Type(models.Model):
    document_type = models.ForeignKey(Doctype, on_delete=CASCADE)
