...
"""
create sms_settings table with fields as below:
sms_gateway_url textfield
message_parameter charfield
receiver_parameter charfield
use_post charfield

"""
class Sms_Settings(models.Model):
    sms_gateway_url = models.CharField(max_length=100, blank=True, null=True)
    message_parameter = models.CharField(max_length=100, blank=True, null=True)
    receiver_parameter = models.CharField(max_length=100, blank=True, null=True)
    use_post = models.CharField(max_length=100, blank=True, null=True)
    def __str__(self):
