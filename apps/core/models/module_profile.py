...
"""
create module_profile table with fields as below:
module_profile_name charfield
module_html charfield

"""
class Module_Profile(models.Model):
    ...
    def __str__(self):
        return self.module_profile_name
