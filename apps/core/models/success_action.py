...
"""
create success_action table with fields as below:
ref_doctype forigen key to doctype table
first_success_message chrfield
message charfield
next_actions_html charfield
next_actions charfield
action_timeout intfield

"""
class Success_Action(models.Model):
    ref_doctype = models.ForeignKey(Doctype, on_delete=models.CASCADE, null=True)
    ...
    def __str__(self):
        return self.first_success_message
    class Meta:
