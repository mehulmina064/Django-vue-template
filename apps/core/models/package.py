...
"""
create package table with fields as below:
readme charfield
package_name charfield
license_type charfield with choices license_types
license charfield

"""
class Package(models.Model):
    readme = models.CharField(max_length=255, blank=True)
    package_name = models.CharField(max_length=255, blank=True)
    license_type = models.CharField(max_length=255, choices=licence_types)
