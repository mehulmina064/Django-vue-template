...
"""
create transaction_log table with fields as below:
row_index charfield
reference_doctype charfield
document_name charfield
timestamp datetimefield
checksum_version charfield
previous_hash charfield
transaction_hash charfield
chaining_hash  charfield
data textfield
amended_from charfield

"""
class Transaction_Log(models.Model):
    row_index = models.CharField(max_length=100, blank=True, null=True)
    reference_doctype = models.CharField(max_length=100, blank=True, null=True)
    document_name = models.CharField(max_length=100, blank=True, null=True)
    timestamp = models.DateTimeField(blank=True, null=True)
    checksum_version = models.CharField(max_length=100, blank=True, null=True)
    ...
    chaining_hash = models.CharField(max_length=100, blank=True, null=True)
    data = models.TextField(blank=True, null=True)
    amended_from = models.CharField(max_length=100, blank=True, null=True)
    def __str__(self):
