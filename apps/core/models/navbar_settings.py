...
"""
create navbar_settings table with fields as below:
app_logo image field
logo_width integer field


"""
class Navbar_Settings(models.Model):
    app_logo = models.ImageField(upload_to='app_logo/', blank=True, null=True)
