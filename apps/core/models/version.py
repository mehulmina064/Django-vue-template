...
"""
create version table with fields as below:
ref_doctype foreign key to doctype
docname charfield
data charfield
table_html charfield
...
class Version(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=CASCADE,related_name='created')
    created_on = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(User, on_delete=CASCADE,related_name='updated')
