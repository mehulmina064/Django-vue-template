...
"""
create UserEmail table with fields as below:
email_account foreign key to email_account table
email_id charfield
awaiting_password booleanfield default false
enable_outgoing booleanfield default false

"""
class UserEmail(models.Model):
    # email_account = models.ForeignKey(to='Email_Account',on_delete=CASCADE)
