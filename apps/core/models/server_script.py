...
"""
create server_script table with fields as below:
script_type charfield with choices script_types
script charfield
reference_doctype foreignkey with doctype
doctype_event charfield with choices doctype_events
api_method charfield
allow_guest booleanfield
disabled booleanfield
event_frequency charfield with choices frequency_choices
module foreignkey with module


"""
class Server_Script(models.Model):
    script_type = models.CharField(max_length=100,choices=script_types)
    script = models.TextField()
    reference_doctype = models.ForeignKey(Doctype,on_delete=CASCADE)
    doctype_event = models.CharField(max_length=100,choices=doctype_events)
    api_method = models.CharField(max_length=100)
    allow_guest = models.BooleanField(default=False)
    disabled = models.BooleanField(default=False)
    event_frequency = models.CharField(max_length=100,choices=frequency_choices)
