...
pending_types={('pending','pending'),('verified','verified'),('rejected','rejected')}
...
"""
create transaction table with fields as below:
language foreigen key language table
context charfield
contributed booleanfield
contribution_status charfield with choices as pending_types
contribution_docname charfield
source_text charfield
translated_text charfield
...
class Translation(models.Model):
    ...
    contribution_status = models.CharField(max_length=100, choices=pending_types)
