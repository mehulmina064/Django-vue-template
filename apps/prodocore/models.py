...
from apps.prodocore import exceptions_gm
# from cor.perms import assign_object_to_member, assign_object_to_group
from apps.prodocore.settings import GROUPS_MANAGER
...
def get_auth_models_sync_func_default(instance):
    from prodocore.settings import GROUPS_MANAGER
